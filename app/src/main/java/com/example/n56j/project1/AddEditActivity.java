...
public class AddEditActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private EditText nameEditText, numberEditText, datailEditText;
    ...
    private void buttonController() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                detailString = datailEditText.getText().toString().trim();

                if (nameString.equals("")) {
                    //Have Space
                    MyAlert myAlert = new MyAlert(AddEditActivity.this,
                            R.drawable.doremon48, "ยังไม่มีชื่อ", "กรุณาใส่ชื่อด้วย คะ");
                    myAlert.myDialog();
                } else if (aBoolean) {
                    // Non Choose Image
                    MyAlert myAlert = new MyAlert(AddEditActivity.this,
                    ...
                    // Non marker
                    MyAlert myAlert = new MyAlert(AddEditActivity.this,
                            R.drawable.doremon48, "ยังไม่ได้เกำหนดพิกัด", "กรุณาเลือกพิกัดด้วย คะ");
                    myAlert.myDialog();
                } else {
    ...
    private void bindWidget() {
        ...
        datailEditText = (EditText) findViewById(R.id.editText3);
